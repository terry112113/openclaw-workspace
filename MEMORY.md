...
| 刑部尚书 | 魏征 | MiniMax-M2.7 | 快速执行、审计 |

---

## 📊 系统配置(2026-03-30 v3.0精简后)
...
| 记忆层级 | 热/温/冷/周/永久 |
| TTS | Microsoft ✅ |
| 模型 | 全部MiniMax-M2.7(统一) |

**Cron(2个精简后):**
| Cron | 频率 | 职责 |
|------|------|------|
| 熔断监控 | 30min | 系统检查,纯系统操作 |
| 三司会审-每日复盘 | 22点 | 静默执行,不打扰皇上 |

**已禁用:** 李元芳学skills.sh、魏征学GitHub、Skills维护(精简合并)
